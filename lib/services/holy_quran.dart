...
class HolyQuran extends StatefulWidget {
  ...
  @override
  _HolyQuranState createState() => _HolyQuranState();
}
...
class _HolyQuranState extends State<HolyQuran> {
  ...
  Future<void> getUserApi() async {
    final response = await http.get(Uri.parse('http://api.alquran.cloud/v1/quran/en.asad'));
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text('Page: ${ayah['page']}', style: TextStyle(color: Colors.teal, fontSize: 12)),
                                            SizedBox(width: 10),
                                            Text('Manzil: ${ayah['manzil']}', style: TextStyle(color: Colors.teal, fontSize: 12)),
                                            SizedBox(width: 10),
                                            Text('Juz: ${ayah['juz']}', style: TextStyle(color: Colors.teal, fontSize: 12)),
                                            SizedBox(width: 10),
                                            Text('Ruku: ${ayah['ruku']}', style: TextStyle(color: Colors.teal, fontSize: 12)),
                                          ],
                                        ),
                                      ),
                                      SizedBox(height: 10),
        ...
        children: [
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(fontWeight: FontWeight.w600, color: Colors.blueAccent, fontSize: 15),
            ),
          ),
        ],
      ),
